<!--begin::Modal-->
<div class="modal fade" id="modal_retirar" data-bs-backdrop="static" tabindex="-1" aria-hidden="true" aria-labelledby="modal_ingresar">
	<!--begin::Modal dialog-->
	<div class="modal-dialog modal-dialog-centered mw-800px">
		...
		<div class="modal-content rounded">
			...
			<div class="modal-header p-5 pb-4 border-bottom-0">
                <h1 class="fw-bold mb-0 fs-2">Retirar de cuenta</h1>
			...
			<div class="modal-body scroll-y px-10 px-lg-15 pt-0 pb-15">
                <form class="" novalidate="" action="modules/cuentasAction.php" method="post">
                    ...
                    <button class="w-100 mb-2 btn btn-lg rounded-3 btn-outline-danger" type="submit">Retirar</button>                    
                  </form>
			</div>
			<!--end::Modal body-->
		</div>
